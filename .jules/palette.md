...
## 2026-08-17 - Actionable tooltips for error states
**Learning:** Passive error tooltips (like "Current status: needs-resync") leave users confused about how to resolve the state. Providing actionable CLI commands directly in the tooltip significantly reduces friction.
**Action:** When a UI element reflects an error state requiring manual intervention, ensure its tooltip includes the exact remediation command.
