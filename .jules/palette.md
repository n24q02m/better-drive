...
## 2026-09-07 - Append disabled reasons to tray menu titles
**Learning:** Standard macOS and Windows system tray menus do not display tooltips on individual menu dropdown items, causing disabled reasons to be invisible.
**Action:** When disabling UI elements due to broken states in tray menus, append the actionable instruction directly to the menu item's title instead of relying on a tooltip.
