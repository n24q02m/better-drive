...
## 2026-08-02 - Dynamic Tooltips for Accessibility
**Learning:** In desktop background applications, tooltips for menu items should be updated alongside dynamic changes to their title or disabled state to preserve context and ensure accessibility for all users, including those using screen readers.
**Action:** Always update a menu item's tooltip (`SetTooltip`) when changing its state or title.
