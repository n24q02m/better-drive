...
## 2026-09-11 - System Tray Menus Tooltips
**Learning:** Standard macOS and Windows system tray menus do not display tooltips on individual menu dropdown items. Do not rely on `MenuItem.SetTooltip` to explain disabled states or recovery steps.
**Action:** Append the disabled reason or recovery action directly to the menu item's title.
